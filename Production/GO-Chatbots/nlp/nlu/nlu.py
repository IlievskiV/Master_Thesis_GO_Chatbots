...
class nlu:
    """
    Natural Language Understanding Unit in the Dialogue System. Used to transform the
    user utterance with a dialogue act in a format:
    
    request_slots: {}, inform_slots: {}, diaact: "", nl: ""
    
    Depending on the domain of the chatbot, the slots and the intent should be specified.
    
    The 'diaact' string is defining the intent of the user utterance, while the slots are
    the pieces of information the chatbot is expecting to receive.
    """
    def __init__(self):
        pass
    ...
    def generate_dia_act(self, annot):
        ...
        if len(annot) > 0:
            print "Generate Dialogue act positive"
            ...
            print "Generate Dialogue act negative"
            return None
