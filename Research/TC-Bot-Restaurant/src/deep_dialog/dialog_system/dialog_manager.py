...
class DialogManager:
    ...
    def initialize_warmup_episode(self, warmup_user_goal):
        ...
        self.episode_over = False
        self.state_tracker.initialize_episode()
        self.user_action = self.user.initialize_warmup_episode(warmup_user_goal)
        self.state_tracker.update(user_action=self.user_action)
    ...
    def initialize_test_episode(self, test_user_goal):
        """
        Initialize test episode such that, the user will follow the goal
        ...
        self.episode_over = False
        self.state_tracker.initialize_episode()
        self.user_action = self.user.initialize_test_episode(test_user_goal)
        self.state_tracker.update(user_action=self.user_action)
