...
sys_request_slots = ['city', 'date', 'numberofpeople', 'food', 'pricerange']

sys_inform_slots = ['city', 'date', 'taskcomplete', 'ticket', 'food', 'pricerange', 'addr']

start_dia_acts = {
    'request':['food', 'city', 'date', 'pricerange', 'numberofpeople', 'ticket', 'numberofpeople']
}
