...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_file', dest='result_file', type=str, default='./deep_dialog/checkpoints/rl_agent/11142016/noe2e_scratch/agt_9_performance_records.json', help='path to the result file')
